...
import { ImpactHighlightsCarousel } from './ImpactHighlightsCarousel';
import { FormatTransparencyPanel } from './FormatTransparencyPanel';
      ...
      <main className={styles.inner}>
        <header className={styles.hero}>
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p>
              HireEdge analyses CVs and job descriptions to craft tailored résumés, outreach kits, and quantified impact highlights.
              Bring those differentiators front-and-centre on the website to attract candidates and hiring teams alike.
            </p>
            <div className={styles.heroGrid}>
              <div className={styles.heroCard}>
                <span style={{ opacity: 0.7, letterSpacing: '0.6px', textTransform: 'uppercase' }}>Insight depth</span>
              ...
              <div className={styles.heroCard}>
                <span style={{ opacity: 0.7, letterSpacing: '0.6px', textTransform: 'uppercase' }}>Outreach ready</span>
              ...
              <div className={styles.heroCard}>
                <span style={{ opacity: 0.7, letterSpacing: '0.6px', textTransform: 'uppercase' }}>Proof of impact</span>
              ...
              <div className={styles.heroCard}>
                <span style={{ opacity: 0.7, letterSpacing: '0.6px', textTransform: 'uppercase' }}>Flexible delivery</span>
